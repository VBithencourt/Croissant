...
import pygame
from mapa_F1 import mapa_3
from tela_inicial import * 
from tela_tutorial import *
from player2 import *
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_r and game_over:  # Reinicia o jogo
                ...
                mapa_3 = [linha[:] for linha in mapa_3]  # Restaura o mapa
                player = Player(1300, 700, 20, 20)  # Cria o player na posição inicial
        ...
        if tutorial_ativo:
            ...
            for linha in range(len(mapa_3)):
                for coluna in range(len(mapa_3[linha])):
                    ...
                    y = linha * altura_tile
                    if mapa_3[linha][coluna] == 1:
                        janela.blit(con, (x, y))
                    elif mapa_3[linha][coluna] == 0:
                        janela.blit(P_lisa, (x, y))
                    elif mapa_3[linha][coluna] == 3:
                        janela.blit(Va1, (x, y))
                    elif mapa_3[linha][coluna] == 'p1':
                        janela.blit(P1, (x, y))
                    elif mapa_3[linha][coluna] == 'p2':
                        janela.blit(P2, (x, y))
                    elif mapa_3[linha][coluna] == 'p3':
                        janela.blit(P3, (x, y))
                    elif mapa_3[linha][coluna] == 'p4':
                        janela.blit(P4, (x, y))
            ...
            if mapa_3[player_pos[1]][player_pos[0]] == 3:
                    game_over = True  # Acabou o jogo, o player pisou no tile 3
                    mortes_player += 1  # Incrementa a morte do player

            if mapa_3[player_pos[1]][player_pos[0]] == 3: #mapa_3[player2_pos[1]][player2_pos[0]] == 3:
                    game_over = True  # Acabou o jogo, um dos jogadores pisou no tile 3
            
            
            if mapa_3[player_pos[1]][player_pos[0]] == 'p1' :# and mapa_3[player2_pos[1]][player2_pos[0]] == 'p1':
